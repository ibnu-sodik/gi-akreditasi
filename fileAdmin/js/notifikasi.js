...
const flashDataAdminInfo = $('.pesan-admin-info').data('flashdata');

if (flashDataAdminInfo) {
	swal({
		title: 'Perhatian.!',
		text: flashDataAdminInfo,
		icon: "info",
		timer : 3000,
		button: false
	});
...
const flashDataAdminWarning = $('.pesan-admin-warning').data('flashdata');

if (flashDataAdminWarning) {
	swal({
		title: 'Perhatian.!',
		text: flashDataAdminWarning,
		icon: "warning",
		timer : 3000,
		button: false
	});
