...
class Website_model extends CI_Model {
	...
	public function simpan_api($api_tinify)
	{
		...
		$this->db->update('site_settings', $object);
	}

	public function simpan_kontak($site_email)
	{
		$object = array(
...
/* Location: .//C/laragon/www/gi-akreditasi/gi_akreditasi/models/admin/Website_model.php */
