													...
													<tr>
														<td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
															...
															<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
																<p>Hai <?= $nama ?>,</p>
																<p>Anda meminta kode untuk melakukan reset password. <br>
																Kode reset password anda adalah :</p>
																<b style="color: #000;"><?= $reset_code; ?></b>
																<br>
																<br>
																Klik Tombol Reset Password untuk mengatur ulang kata sandi anda.
															</div>
														</td>
													</tr>
												</tbody>
													...
													<tr>
														<td class="table-col-td" width="378" style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; font-weight: normal; width: 378px;" valign="top" align="left">
															<div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">
																<a href="<?= $url_reset ?>" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp; Reset Password &nbsp;</a>
															</div>
																...
																<tbody>
																	<tr>
																		<td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;" valign="top">
																			<a href="<?= site_url('home') ?>" style="color: #428bca; text-decoration: none; background-color: transparent;"><?= $site_name ?> &copy; <?= date('Y') ?></a>
																			<br>
