							...
							<form class="form-horizontal" role="form" action="<?= $form_aksi; ?>" method="POST">
									...
									<div class="col-sm-9">										
										<select class="form-control select2" name="induk" id="induk" data-placeholder="Pilih Induk...">
											...
											<?php foreach ($main_menu->result() as $row): ?>
												<option value="<?= $row->id_menu; ?>"><?= $row->judul_menu; ?></option>
											<?php endforeach; ?>
										</select>
								...
								<div class="form-group" id="jenis_menu">									
									...
									<div class="col-sm-9">
										...
										<?php echo form_error('jenis_menu') ?>
									</div>
								</div>
								...
								<div class="form-group" id="link_url">									
									...
									<div class="col-sm-4">
										<select name="jenis_link" class="form-control select2">
											...
											<option value="2">Link External</option>
										</select>
									</div>
									<div class="col-sm-5">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<label class="inline">
											<input name="target" value="_blank" type="checkbox" class="ace">
