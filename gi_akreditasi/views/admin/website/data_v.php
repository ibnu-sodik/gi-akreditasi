						...
						<form class="form-horizontal" method="POST" action="<?= $aksi_logo ?>" enctype="multipart/form-data">
							...
							<div class="col-md-6 col-xs-12">
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="file" id="site_logo" name="site_logo" class="dropify"  data-height="190" data-default-file="<?= base_url('fileWeb/images/'.$row['site_logo']) ?>"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="file" id="site_favicon" name="site_favicon" class="dropify"  data-height="190" data-default-file="<?= base_url('fileWeb/images/'.$row['site_favicon']) ?>"/>
