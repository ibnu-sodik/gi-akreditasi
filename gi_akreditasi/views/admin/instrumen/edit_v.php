...
<div class="row">	
	...
	<form class="form-horizontal" method="POST" enctype="multipart/form-data" role="form" action="<?= $form_action.'/'.$row['id_instrumen']; ?>">
		...
		<div class="col-md-8 col-xs-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="judul" placeholder="Judul" value="<?= $row['nama_instrumen'] ?>" name="judul" class="form-control judul" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="slug" value="<?= $row['slug_instrumen'] ?>" placeholder="Permalink" name="slug" class="form-control slug" readonly />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="form-control" name="konten" id="summernote"><?= $row['konten_instrumen'] ?></textarea>
				</div>
			</div>
		</div>
		<div class="col-md-4 col-xs-12">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<select class="form-control chosen-select" name="kategori" id="kategori" data-placeholder="Pilih Kategori...">
						...
						<?php foreach ($kategori->result() as $val): ?>
							<?php if ($row['kategori_instrumen'] == $val->id_kategori): ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<textarea placeholder="Meta Deskripsi" name="deskripsi" for="meta-deskripsi" class="form-control" rows="10"><?= $row['deskripsi_instrumen'] ?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="hidden" name="id_instrumen" value="<?= $row['id_instrumen']; ?>">
