...
class Video extends CI_Controller {
	...
	{				
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->log_model->save_log($this->session->userdata('id_login'), 3, "Mengubah video dengan judul $nama_video");
	...
	{		
		...
		if ($this->form_validation->run() === FALSE) {
			...
			// 0=login, 1=logout, 2=create, 3=update, 4=delete, 5=resetPass, 6=reply
			$this->log_model->save_log($this->session->userdata('id_login'), 2, "Menambah video dengan judul $nama_video");
	...
	public function hapus($id_video)
	{
		...
		// }
		// 0=login, 1=logout, 2=create, 3=update, 4=delete, 5=resetPass, 6=reply
		$this->log_model->save_log($this->session->userdata('id_login'), 4, 'Hapus video '.$data->nama_video);
	...
	public function index()
	{
		...
		$data['url'] 				= site_url('admin/video');
		$data['canonical'] 			= site_url('admin/video');
...
/* Location: .//C/laragon/www/gi-akreditasi/gi_akreditasi/controllers/admin/Video.php */
